...
char auth[] = "ABCD";  //Enter your Blynk Auth token
char ssid[] = "XYZ";  //Enter your WIFI SSID
char pass[] = "XYZ";  //Enter your WIFI Password
...
void soilMoistureSensor() {
  ...
  if(value <=10)
  {
    for(i=0;i<20;i++)
    {
      ...
      relay1State = !relay1State; //pump will be on and off
      digitalWrite(RELAY_PIN_1, relay1State);
      if(value>70)
       {
        digitalWrite(RELAY_PIN_1, LOW);
